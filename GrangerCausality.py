...
def Granger_Causality(df, lags):  
    ...
    df2 = df1[df1.columns[::-1]] # y as function of x
    ...
    for i in range(1,lags+1):
        ...
        df2_r = lagger_e(p=lags,df = df2.iloc[:,0:1])# Eq2 restricted
        df2_u = lagger_e(p=lags,df = df2)            # Eq2 unrestricted (all vars)
        ...
        p_value_f2 = 1- f.cdf(f2, q2,n-ssr1_u_m)
